...
public class Message {
    ...
    public static final String MSG_INCORRECT_PASWORD = "Incorrect password, please check password again!";
    public static final String MSG_EMAIL_EXIST = "This email is already in use!";
    public static final String MSG_EMAIL_NOT_REGISTER = "Email not registered!";
    ...
    public static final String MSG_GET_PRODUCT_DISPLAY_LIST_FAIL = "Fail to get product display list!";
    public static final String MSG_GET_PRODUCT_DISPLAY_LIST_SUCCESS = "Get product display list successfully!";
    ...
    public static final String MSG_DATA_NULL = "Data is null";
